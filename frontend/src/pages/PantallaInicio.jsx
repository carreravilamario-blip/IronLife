...
export default function PantallaInicio() {
  ...
  return (
    <div className="inicio-page" style={{ display: "flex", flexDirection: "column", minHeight: "100%", background: H.bg, color: H.text, fontFamily: H.sans }}>
      <header className="inicio-header" style={{ padding: "24px 32px 22px", borderBottom: `1px solid ${H.line}` }}>
      ...
      <div className="inicio-body" style={{ flex: 1, padding: "24px 32px 40px" }}>
        {/* fila de stats */}
        <div className="inicio-stats" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 14, marginBottom: 22 }}>
        ...
        <div className="inicio-grid" style={{ display: "grid", gridTemplateColumns: "minmax(0,1.55fr) minmax(340px,1fr)", gap: 22, alignItems: "start" }}>

          {/* Calendario: en escritorio siempre visible; en móvil, togglable */}
          <div className="inicio-cal-wrapper">
            {/* Toggle solo visible en móvil (CSS lo controla) */}
            <button className="inicio-cal-toggle" onClick={() => setCalVisible(v => !v)}>
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>
              </svg>
              {calVisible ? "Ocultar calendario" : "Ver calendario del mes"}
            </button>
            <div className={`inicio-cal-content${calVisible ? " visible" : ""}`}>
              <Calendario
