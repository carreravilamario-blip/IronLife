      ...
      <div className="auth-cuerpo">
        ...
        <main className="auth-form-panel">
          ...
          <div className="social">
            <button type="button" className="boton-social">
            ...
            <button type="button" className="boton-social">
              <svg viewBox="0 0 384 512" fill="currentColor" aria-hidden="true">
                <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C73.6 141.6 24 184.8 24 272.4c0 25.9 4.7 52.7 14.2 80.3 12.6 36.4 58 125.5 105.3 124 24.7-.6 42.2-17.5 74.4-17.5 31.2 0 47.4 17.5 74.9 17.5 47.7-.7 88.8-81.7 100.8-118.2-64-30.2-60.9-88.5-60.9-89.8zm-50.2-184c24.1-28.6 21.9-54.6 21.2-64-21.3 1.2-46 14.5-60 30.8-15.5 17.4-24.6 39-22.6 63.5 23 1.8 44-10 61.4-30.3z" />
              </svg>
              APPLE
            </button>
          </div>
